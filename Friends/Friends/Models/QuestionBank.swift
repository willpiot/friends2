...
struct QuestionBank {
    static let questions: [Question] = [
        ...
        Question(id: 29, text: "I consider myself politically conservative.", category: .beliefs),
        Question(id: 30, text: "I consider myself politically liberal.", category: .beliefs),
